...
class DetailNew(DetailView, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['comments'] = self.linked_comm_table.objects.raw(get_likescomment_request(
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            if 'like_type' and 'comm_id' in request.POST:
                ...
                edit_likes(self.linked_comm_table, request, *args, **kwargs)
            elif 'like_type' in request.POST:
                kwargs['addit_table'] = self.linked_likes_table
                pk = edit_likes(self.model, request, *args, **kwargs)
